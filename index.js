    ...
    .then(function (response) {
      ...
      items.each((i, elem) => {
        ...
        itemData.imageURL = $(elem)
          .find(
            // "div > div.s-item__image-section > div > a:nth-child(1) > div > img" // original selector
            // "#srp-river-results > ul > li:nth-child(2) > div > div.s-item__image-section > div > a > div > img"
            "div.s-item__image-section > div > a > div > img"
          )
          .attr("src");
        //div > div.s-item__info.clearfix > a > h3
        itemData.title = $(elem)
          .find("div > div.s-item__info.clearfix > a > h3") // original css: "div > div.s-item__info.clearfix > a > h3"
          .text()
          .trim();
